...
- Any classes specific to `dart:io` platforms can now be imported via `import 'package:w_dio/io.dart';`.
  Classes specific to web can be imported via `import 'package:w_dio/browser.dart';`.
