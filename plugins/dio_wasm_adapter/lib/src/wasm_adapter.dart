...
Dio createDio([BaseOptions? options]) {
  ...
  if (kIsWeb) {
    dio.httpClientAdapter = WasmHttpClientAdapter();
  }
  return dio;
}

/// A [HttpClientAdapter] for WASM
class WasmHttpClientAdapter implements HttpClientAdapter {
  WasmHttpClientAdapter({this.withCredentials = false});
