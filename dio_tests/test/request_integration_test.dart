...
import 'package:dio_tests/src/matcher.dart';
import 'package:dio_tests/src/utils.dart';
import 'package:test/test.dart';
import 'adapter/io.dart' if (dart.library.html) 'adapter/web.dart';

void main() {
  for (final adapter in adapters) {
    group('requests(${adapter.runtimeType})', () {
      late Dio dio;
